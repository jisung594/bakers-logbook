...
export const DENSITY_DATA: Ingredient[] = [
    ...
    { 
        ...
        name: 'Powdered Sugar', 
        units: [
            { unit: 'tbsp', density_g_per_unit: 8 },
        ]
    },
    { 
        key: 'salt_kosher', 
    ...
    { 
        ...
        name: 'Water', 
        units: [
            { unit: 'cup', density_g_per_unit: 236 },
        ]
    },
    { 
        key: 'milk', 
    ...
    { 
        ...
        name: 'Butter (Solid)', 
        units: [
            { unit: 'cup', density_g_per_unit: 227 },
        ]
    },
    { 
        key: 'egg', 
        name: 'Egg (Large)', 
        units: [
            { unit: 'each', density_g_per_unit: 50 },
        ]
    },
];
